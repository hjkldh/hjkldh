...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.appearance_mode_label.grid(row=1, column=5, padx=10, pady=(10, 10),sticky="e")
        ...
        self.appearance_mode_optionemenu.grid(row=1, column=6, padx=0, pady=(10, 10),sticky="w")
        #文字标签-缩放比例
        ...
        #self.tabview.grid(row=2, column=0, padx=(0, 0), pady=(20, 20), sticky="nsew")
        self.tabview.pack(expand=True, fill="both", padx=10, pady=10)
        self.tabview.add("课程考勤")
        self.tabview.add("考核记录单")
        self.tabview.add("上传模版")
        self.tabview.add("成绩分析表")
        self.tabview.add("班主任考勤表")
        self.tabview.set("课程考勤")
#page1
        self.frame_page1 = customtkinter.CTkFrame(self.tabview.tab("课程考勤"), width=10, height=20, corner_radius=0)
...
#page2
        self.frame_page2 = customtkinter.CTkFrame(self.tabview.tab("考核记录单"), width=10, height=20, corner_radius=0)
...
#page3
        self.frame_page3 = customtkinter.CTkFrame(self.tabview.tab("上传模版"), width=10, height=20, corner_radius=0)
...
#page4
        self.frame_page4 = customtkinter.CTkFrame(self.tabview.tab("成绩分析表"), width=10, height=20, corner_radius=0)
        self.frame_page4.pack(expand=True, fill="both", padx=10, pady=10)
        self.page4_lable = customtkinter.CTkLabel(self.frame_page4, text='将试卷及分析表上传至 deepseek 或者 kimi，让其按分析表分析即可!')
        self.page4_lable.grid(row=0, column=0)
#page5
        self.frame_page5 = customtkinter.CTkFrame(self.tabview.tab("班主任考勤表"), width=10, height=20, corner_radius=0)

...
class CTkDatePicker(ctk.CTkFrame):
    ...
    def build_calendar(self):
        ...
        self.chinese_month = ["一月", "二月", "三月", "四月", "五月", "六月",
                              "七月", "八月", "九月", "十月", "十一月", "十二月"]
        ...
        month_label = ctk.CTkLabel(self.calendar_frame,
                                   text=f"{self.chinese_month[self.current_month-1]}, {self.current_year}")#显示中文月份
        ...
        for week in range(2, 8):
            for day_col in range(7):
                if week == 2 and day_col < start_day:
                    ...
                    btn = ctk.CTkButton(self.calendar_frame, text=str(day),text_color=("black","white"), width=3, command=lambda day=day: self.select_date(day), fg_color="transparent")

...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        #文字标签
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="期末考核辅助工具", font=customtkinter.CTkFont(size=15, weight="bold"))
        ...
        self.appearance_mode_label.grid(row=1, column=0, padx=10, pady=(10, 10),sticky="e")
        ...
        self.appearance_mode_optionemenu.grid(row=1, column=2, padx=0, pady=(10, 10),sticky="w")
        #文字标签-缩放比例
        self.scaling_label = customtkinter.CTkLabel(self.sidebar_frame, text="UI Scaling:", anchor="w")
        self.scaling_label.grid(row=1, column=7, padx=10, pady=(10, 10),sticky="e")
        self.scaling_optionemenu = customtkinter.CTkOptionMenu(self.sidebar_frame, width=100, values=["80%", "90%", "100%", "110%", "120%"],
                                                               command=self.change_scaling_event)
        self.scaling_optionemenu.grid(row=1, column=8, padx=0, pady=(10, 10),sticky="w")

        self.option_type = customtkinter.CTkSegmentedButton(self.sidebar_frame,width=10, height=10,values=["课程考勤","考核记录单", "上传模版", "成绩分析表","班主任考勤表"], command=self.filter_packages)
        self.option_type.set("课程考勤")
        self.option_type.grid(row=2, column=0, rowspan=1, columnspan=10, padx=10, pady=10, sticky="ew")
        self.frame_page1 = customtkinter.CTkFrame(self, width=10, height=20, corner_radius=0)
        self.frame_page2 = customtkinter.CTkFrame(self, width=10, height=20, corner_radius=0)
        self.frame_page3 = customtkinter.CTkFrame(self, width=10, height=20, corner_radius=0)
        self.frame_page4 = customtkinter.CTkFrame(self, width=10, height=20, corner_radius=0)
        self.frame_page5 = customtkinter.CTkFrame(self, width=10, height=20, corner_radius=0)
        self.first_page("课程考勤")
    ...
    def filter_packages(self, type_):
        ...
        if type_=="课程考勤":
            self.first_page(type_)
        elif type_=="考核记录单":
            self.second_page(type_)
        elif type_=="上传模版":
            self.thrid_page(type_)
        elif type_=="成绩分析表":
            self.fouth_page(type_)
        elif type_=="班主任考勤表":
            self.fifth_page(type_)

    def first_page(self,type):
        if type == "课程考勤":
            ...
            self.button_notice0 = customtkinter.CTkButton(self.frame_page1, width=10, height=20, corner_radius=3,
                                                          text='示例', fg_color='red', hover_color="green",
                                                          command=self.page1_top0)
            ...
            self.page1_entry1 = customtkinter.CTkEntry(master=self.frame_page1,
                                                       placeholder_text="请选择文件或者粘贴文件路径", state="normal",
                                                       width=500, height=20, corner_radius=3)
            self.page1_entry1.grid(row=1, column=1, padx=(20, 10), pady=(20, 20), sticky="w")

            self.button_1 = customtkinter.CTkButton(self.frame_page1, width=10, height=20, corner_radius=3,
                                                    text='选择文件',
                                                    command=self.page1_file1)
            self.button_1.grid(row=1, column=2, padx=10, pady=10)
            self.button_notice1 = customtkinter.CTkButton(self.frame_page1, width=10, height=20, corner_radius=3,
                                                          text='示例', fg_color='red', hover_color="green",
                                                          command=self.page1_top1)
            self.button_notice1.grid(row=1, column=3, padx=10, pady=10)
            self.page1_toplevel1 = None
            self.label_3 = customtkinter.CTkLabel(self.frame_page1, text='3.选择系统名册：')
            self.label_3.grid(row=2, column=0, padx=10, pady=10, sticky="w")

            self.page1_entry2 = customtkinter.CTkEntry(master=self.frame_page1,
                                                       placeholder_text="请选择文件或者粘贴文件路径", state="normal",
                                                       width=500, height=20, corner_radius=3)
            ...
            self.page1_entry3 = customtkinter.CTkEntry(master=self.frame_page1,
                                                       placeholder_text="请选择或粘贴输出目录，不选择则输出到系统名册的同级目录",
                                                       state="normal", width=500, height=20, corner_radius=3)
    ...
    def second_page(self,type):
        if type == "考核记录单":
            ...
            self.page2_entry1 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认20",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry2 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认20",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry3 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry4 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认60",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry5 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry6 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry7 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry8 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry9 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry10 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="默认 0",
                                                        state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page2_entry11 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="选择18周考勤文件，即“课程考勤”生成为文件",
                                                        state="normal", width=500, height=20, corner_radius=3)
            self.page2_entry11.grid(row=2, column=1, columnspan=6, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_button1 = customtkinter.CTkButton(self.frame_page2, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page2_file1)
            ...
            self.page2_entry12 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="选择班级名册文件",
                                                        state="normal", width=500, height=20, corner_radius=3)
            self.page2_entry12.grid(row=3, column=1, columnspan=6, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_button2 = customtkinter.CTkButton(self.frame_page2, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page2_file2)
            self.page2_button2.grid(row=3, column=7, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_label13 = customtkinter.CTkLabel(self.frame_page2, text='3、请选择课程作业成绩名册：')
            self.page2_label13.grid(row=4, column=0, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_entry13 = customtkinter.CTkEntry(master=self.frame_page2,
                                                        placeholder_text="不选择则以设置的分数打分", state="normal",
                                                        width=500, height=20, corner_radius=3)
            self.page2_entry13.grid(row=4, column=1, columnspan=6, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_button3 = customtkinter.CTkButton(self.frame_page2, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page2_file3)
            self.page2_button3.grid(row=4, column=7, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_label14 = customtkinter.CTkLabel(self.frame_page2, text='4、请选择课程试卷成绩名册：')
            self.page2_label14.grid(row=5, column=0, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_entry14 = customtkinter.CTkEntry(master=self.frame_page2, placeholder_text="请选择试卷成绩文件，表头应该包含“学号”和“成绩”两列",
                                                        state="normal", width=500, height=20, corner_radius=3)
            self.page2_entry14.grid(row=5, column=1, columnspan=6, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_button4 = customtkinter.CTkButton(self.frame_page2, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page2_file4)
            ...
            self.page2_entry15 = customtkinter.CTkEntry(master=self.frame_page2,
                                                        placeholder_text="请选择或者粘贴输出路径，不选择则输出到考勤同名目录",
                                                        state="normal", width=500, height=20, corner_radius=3)
            self.page2_entry15.grid(row=6, column=1, columnspan=6, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page2_button5 = customtkinter.CTkButton(self.frame_page2, width=10, height=20, corner_radius=3,
                                                         text='选择目录', command=self.page2_dir1)
    ...
    def thrid_page(self,type):
        if type == "上传模版":
            ...
            self.page3_entry1 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="默认60",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page3_entry2 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="默认0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page3_entry3 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="默认20",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page3_entry4 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="默认20",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page3_entry5 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="默认0",
                                                       state="normal", width=50, height=20, corner_radius=3)
            ...
            self.page3_entry6 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="请选择模版文件",
                                                       state="normal", width=500, height=20, corner_radius=3)
            self.page3_entry6.grid(row=2, column=1, columnspan=11, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page3_button1 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page3_file1)
            self.page3_button1.grid(row=2, column=8, padx=(20, 10), pady=(20, 20), sticky="w")
            self.button_notice0 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                          text='示例', fg_color='red', hover_color="green",
                                                          command=self.page3_top0)
            ...
            self.page3_entry7 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="请选择成绩记录表，即“考核记录单”中导出文件",
                                                       state="normal", width=500, height=20, corner_radius=3)
            self.page3_entry7.grid(row=3, column=1, columnspan=11, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page3_button2 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                         text='选择文件', command=self.page3_file2)
            ...
            self.page3_entry8 = customtkinter.CTkEntry(master=self.frame_page3, placeholder_text="没有期中成绩则不选择",
                                                       state="normal", width=500, height=20, corner_radius=3)
            self.page3_entry8.grid(row=4, column=1, columnspan=11, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page3_button3 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                         text='选择目录', command=self.page3_file3)
            ...
            self.page3_entry9 = customtkinter.CTkEntry(master=self.frame_page3,
                                                       placeholder_text="不选择则输出到模板同目录", state="normal",
                                                       width=500, height=20, corner_radius=3)
            self.page3_entry9.grid(row=5, column=1, columnspan=11, padx=(20, 10), pady=(20, 20), sticky="w")
            self.page3_button4 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                         text='选择目录', command=self.page3_dir1)
            ...
            self.page3_button5 = customtkinter.CTkButton(self.frame_page3, width=10, height=20, corner_radius=3,
                                                         text='开始处理', command=self.page3_process)
            self.page3_button5.grid(row=6, column=1, padx=(20, 10), pady=(20, 20), sticky="w")
    def fouth_page(self,type):
        if type == "成绩分析表":
            self.frame_page1.pack_forget()
            self.frame_page2.pack_forget()
            self.frame_page3.pack_forget()
            ...
            self.page4_lable = customtkinter.CTkLabel(self.frame_page4,
                                                      text='将试卷及分析表上传至 deepseek 或者 kimi，让其按分析表分析即可!')
            self.page4_lable.grid(row=0, column=0)
    def fifth_page(self,type):
        if type == "班主任考勤表":
            self.frame_page1.pack_forget()
            self.frame_page2.pack_forget()
            self.frame_page3.pack_forget()
            ...
            self.page5_entry1 = customtkinter.CTkEntry(master=self.frame_page5,
                                                       placeholder_text="请选择班级考勤文件或者粘贴文件路径",
                                                       state="normal", width=500, height=20, corner_radius=3)
            ...
            self.page5_lable1 = customtkinter.CTkLabel(self.frame_page5,
                                                       text='提示，请参考下图：（导出后不要更改表格，同一堂前后节迟到按一次计算）',
                                                       text_color='red')
            self.page5_lable1.grid(row=1, column=0, columnspan=3, padx=(20, 10), sticky="w")
            self.page5_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "class_attendance.png")),
                                                      size=(700, 267))
            self.page5_image_lable = customtkinter.CTkLabel(self.frame_page5, text="", image=self.page5_image)
            self.page5_image_lable.grid(row=2, column=0, columnspan=3, padx=20, pady=10, sticky="w")
            ...
            self.page5_entry2 = customtkinter.CTkEntry(master=self.frame_page5,
                                                       placeholder_text="请选择或者粘贴输出路径，不选择则输出到考勤同名目录",
                                                       state="normal", width=500, height=20, corner_radius=3)
    ...
    def page1_file1(self):
        self.file_path = customtkinter.filedialog.askopenfilename(title="请选择文件", filetypes=(
